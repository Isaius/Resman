# Generated by Django 2.2.2 on 2019-06-15 21:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='recurso',
            name='categoria',
            field=models.CharField(choices=[('espacos', 'Espaço'), ('acessorios', 'Acessórios'), ('computadores', 'Computadores'), ('projetores', 'Projetores'), ('moveis', 'Móveis')], max_length=20),
        ),
        migrations.AlterField(
            model_name='recurso',
            name='identificador',
